...
class MeMoments extends StatefulWidget {
  @override
  _MeMomentsState createState() => _MeMomentsState();
}

class _MeMomentsState extends State<MeMoments> with WidgetsBindingObserver {
  var width;
  var top;
  bool show = false;
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        '今天',
                        style: TextStyle(fontSize: ScreenUtil.getInstance().setWidth(54)),
                      ),
                      Container(
